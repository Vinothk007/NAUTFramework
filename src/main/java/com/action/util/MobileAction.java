...
public class MobileAction {
	...
	public static final void openURL(String openUrl) {
		String status = "FAIL";
		try {
			MobileDriverManager.getDriver().get(openUrl);
			status = "PASS";
		} catch (Exception e) {
	...
	/*
	 * click - To click on MobileElement
	 * 
	 */
	public static final void click(String locator, String objValue) {
		String status = "FAIL";
		try {
			WebElement element = getElement(MobileDriverManager.getDriver(), locator, objValue);
			element.click();
			status = "PASS";
		} catch (Exception e) {
			ExceptionHandler.handleException(e);
	...
	/*
	 * click - To double click on MobileElement
	 * 
	 */
	public static final void doubleClick(String locator, String objValue) {
		...
		try {
			WebElement element = getElement(MobileDriverManager.getDriver(), locator, objValue);
			new Actions(MobileDriverManager.getDriver()).doubleClick(element).perform();
			status = "PASS";
		} catch (Exception e) {
			ExceptionHandler.handleException(e);
		} finally {
	...
	/*
	 * click - To contextClick on MobileElement
	 * 
	 */
	public static final void contextClick(String locator, String objValue) {
		...
		try {
			WebElement element = getElement(MobileDriverManager.getDriver(), locator, objValue);
			new Actions(MobileDriverManager.getDriver()).contextClick(element).perform();
			status = "PASS";
		} catch (Exception e) {
			ExceptionHandler.handleException(e);
		} finally {
	...
	/*
	 * hideKeyboard - To hide mobile keyboard
	 * 
	 */
	public static final void hideKeys() {
		String status = "FAIL";
		try {
			IOSDriver driver = (IOSDriver) MobileDriverManager.getDriver();
			driver.hideKeyboard("return");
			status = "PASS";
		} catch (Exception e) {
			ExceptionHandler.handleException(e);
		} finally {
			Report.printOperation("hideKeyboard");
			Report.printStatus(status);
		}
	}
	...
	public static final void closeBrowser() {
		String status = "FAIL";
		try {
			MobileDriverManager.getDriver().close();
			status = "PASS";
		} catch (Exception e) {
			ExceptionHandler.handleException(e);
		} finally {
	...
	public static final Alert switchToAlert() {
		...
		String status = "FAIL";
		try {
			alert = MobileDriverManager.getDriver().switchTo().alert();
			status = "PASS";
		} catch (Exception e) {
			ExceptionHandler.handleException(e);
		} finally {
	...
	public static final void highlightElement(String locator, String objValue) {
		String status = "FAIL";
		JavascriptExecutor js = (JavascriptExecutor) MobileDriverManager.getDriver();
		try {
			WebElement element = getElement(MobileDriverManager.getDriver(), locator, objValue);
	...
	public final String getCurrentUrl() {
		...
		String status = "FAIL";
		try {
			currentUrl = MobileDriverManager.getDriver().getCurrentUrl();
			status = "PASS";
		} catch (Exception e) {
			ExceptionHandler.handleException(e);
		} finally {
	...
	public final String getPageSource() {
		...
		String status = "FAIL";
		try {
			pageSource = MobileDriverManager.getDriver().getPageSource();
			status = "PASS";
		} catch (Exception e) {
			ExceptionHandler.handleException(e);
		} finally {
	...
	public static final void switchFrameByName(String name) {
		String status = "FAIL";
		try {
			MobileDriverManager.getDriver().switchTo().frame(name);
			status = "PASS";
		} catch (Exception e) {
			ExceptionHandler.handleException(e);
		} finally {
	...
	public static final void switchFrameByIndex(int index) {
		String status = "FAIL";
		try {
			MobileDriverManager.getDriver().switchTo().frame(index);
			status = "PASS";
		} catch (Exception e) {
			ExceptionHandler.handleException(e);
		} finally {
	...
	public final void switchFrameByWebElement(String locator, String objValue) {
		...
		try {
			WebElement element = getElement(MobileDriverManager.getDriver(), locator, objValue);
			MobileDriverManager.getDriver().switchTo().frame(element);
			status = "PASS";
		} catch (Exception e) {
			ExceptionHandler.handleException(e);
		} finally {
	...
	public static final void switchToDefaultContent() {
		String status = "FAIL";
		try {
			MobileDriverManager.getDriver().switchTo().defaultContent();
			status = "PASS";
		} catch (Exception e) {
			ExceptionHandler.handleException(e);
		} finally {
	...
	public static final void switchToParentFrame() {
		String status = "FAIL";
		try {
			MobileDriverManager.getDriver().switchTo().parentFrame();
			status = "PASS";
		} catch (Exception e) {
			ExceptionHandler.handleException(e);
		} finally {
	...
	public final List<WebElement> getElements(String locator, String objValue) {
		...
		String status = "FAIL";
		try {
			lstElement = getElements(MobileDriverManager.getDriver(), locator, objValue);
			status = "PASS";
		} catch (Exception e) {
			ExceptionHandler.handleException(e);
		} finally {
	...
	public static final void validateTitle(String pageTitle) {
		String status = "FAIL";
		try {
			if (MobileDriverManager.getDriver().getTitle().equals(pageTitle))
				status = "PASS";
		} catch (Exception e) {
			ExceptionHandler.handleException(e);
		} finally {
	...
	public static final void navigateForward() {
		String status = "FAIL";
		try {
			MobileDriverManager.getDriver().navigate().forward();
			status = "PASS";
		} catch (Exception e) {
			ExceptionHandler.handleException(e);
		} finally {
	...
	public static final void refresh() {
		String status = "FAIL";
		try {
			MobileDriverManager.getDriver().navigate().refresh();
			status = "PASS";
		} catch (Exception e) {
			ExceptionHandler.handleException(e);
		} finally {
	...
	public static final Set<String> getWindowHandles() {
		...
		String status = "FAIL";
		try {
			handles = MobileDriverManager.getDriver().getWindowHandles();
			status = "PASS";
		} catch (Exception e) {
			ExceptionHandler.handleException(e);
		} finally {
	...
	public static final void switchToWindow(String windowHandle) {
		String status = "FAIL";
		try {
			MobileDriverManager.getDriver().switchTo().window(windowHandle);
			status = "PASS";
		} catch (Exception e) {
			ExceptionHandler.handleException(e);
		} finally {
