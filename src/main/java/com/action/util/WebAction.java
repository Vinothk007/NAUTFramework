...
public class WebAction {
	 ...
	 * 
	 */
	public static final void waitforVisible(String objValue) {
		String status = "FAIL";
		try {
			
			
			WebDriverManager.getDriver().manage().timeouts().implicitlyWait(4,TimeUnit.SECONDS);
			@SuppressWarnings("deprecation")
			WebDriverWait wait=new WebDriverWait(WebDriverManager.getDriver(),0);						
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(objValue)));
	...
	public static final void waitforVisiblilty(String objValue) {
		String status = "FAIL";
		try {
