...
public class MobActionAndroid {
	...
	public MobActionAndroid(AndroidDriver driver) {
		this.driver = driver;
	}
	...
	public WebElement findElement(By locator) {
		try {
			...
			Report.printKey("Element not found" + locator);
			throw e;
		}
	}
	...
	public void setContext(String context) {
		...
		if (contextNames.contains(context)) {
			...
			Report.printKey("Context changed successfully");
		} else {
			Report.printKey(context + "not found on this page");
		}

		Report.printKey("Current context" + ((AndroidDriver) driver).getContext());
	}
	...
	public void longPress(By locator) {
		try {
			...
			Report.printKey("Long press successful on element: " + element);
		} catch (NoSuchElementException e) {
			Report.printKey("Element not found" + locator);
			throw e;
		}
	...
	public void longPress(int x, int y) {
		...
		Report.printKey("Long press successful on coordinates: " + "( " + x + "," + y + " )");
